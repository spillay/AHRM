...
class Routes(
  ...
  def documentation = List(
    ...
    ("""POST""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """api/genentropy""", """com.dsleng.controllers.BLController.genEntropy"""),
...
## NoDocs ###""",
  ...
  // @LINE:34
  private[this] lazy val com_dsleng_controllers_BLController_genEntropy2_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/genentropy")))
  )
  private[this] lazy val com_dsleng_controllers_BLController_genEntropy2_invoker = createInvoker(
    BLController_4.genEntropy,
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
  ...
  // @LINE:37
  private[this] lazy val com_dsleng_controllers_BLController_query3_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/query")))
  )
  private[this] lazy val com_dsleng_controllers_BLController_query3_invoker = createInvoker(
  ...
  // @LINE:40
  private[this] lazy val com_dsleng_controllers_BLController_emotion4_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/emotion")))
  )
  private[this] lazy val com_dsleng_controllers_BLController_emotion4_invoker = createInvoker(
  ...
  // @LINE:43
  private[this] lazy val com_dsleng_controllers_BLController_entropy5_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/entropy")))
  )
  private[this] lazy val com_dsleng_controllers_BLController_entropy5_invoker = createInvoker(
  ...
  // @LINE:46
  private[this] lazy val com_dsleng_controllers_BLController_deception6_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/deception")))
  )
  private[this] lazy val com_dsleng_controllers_BLController_deception6_invoker = createInvoker(
  ...
  // @LINE:50
  private[this] lazy val com_dsleng_controllers_CredentialsAuthController_authenticate7_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/auth/signin/credentials")))
  )
  private[this] lazy val com_dsleng_controllers_CredentialsAuthController_authenticate7_invoker = createInvoker(
...
## NoDocs ###""",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:34
    case com_dsleng_controllers_BLController_genEntropy2_route(params@_) =>
      call { 
        com_dsleng_controllers_BLController_genEntropy2_invoker.call(BLController_4.genEntropy)
      }
  
    // @LINE:37
    case com_dsleng_controllers_BLController_query3_route(params@_) =>
      call { 
        com_dsleng_controllers_BLController_query3_invoker.call(BLController_4.query)
      }
  
    // @LINE:40
    case com_dsleng_controllers_BLController_emotion4_route(params@_) =>
      call { 
        com_dsleng_controllers_BLController_emotion4_invoker.call(BLController_4.emotion)
      }
  
    // @LINE:43
    case com_dsleng_controllers_BLController_entropy5_route(params@_) =>
      call { 
        com_dsleng_controllers_BLController_entropy5_invoker.call(BLController_4.entropy)
      }
  
    // @LINE:46
    case com_dsleng_controllers_BLController_deception6_route(params@_) =>
      call { 
        com_dsleng_controllers_BLController_deception6_invoker.call(BLController_4.deception)
      }
  
    // @LINE:50
    case com_dsleng_controllers_CredentialsAuthController_authenticate7_route(params@_) =>
      call { 
        com_dsleng_controllers_CredentialsAuthController_authenticate7_invoker.call(CredentialsAuthController_2.authenticate)
      }
