...
class DeptModel extends React.Component {
    constructor(props) {
        super(props);
        console.log("In Constructor of DeptModel")
        var baseView = new View();
        var cf = JSON.parse(dashConfig.DeptView);
        ...
        return (
            <div className="infoPanel">
                <div className="panel-heading">
                    <i className="fa fa-info-circle" /> Department Analysis
                    </div>
...
export default withAuth(withTour(withNav(DeptModel,{title:'Department Analysis'}), steps));