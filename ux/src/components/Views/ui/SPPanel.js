...
export default class SPPanel extends React.Component {
    /*
    Props available: 
    - panelCustomClass 
    ...
    */
    render() {
        return (
            <div id={this.props.id} className={["panel", this.props.panelCustomClass].join(' ') || "panel panel-default"} onClick={this.props.action}>
                {this.props.header &&
